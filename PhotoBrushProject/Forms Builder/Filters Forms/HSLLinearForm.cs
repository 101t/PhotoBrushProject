...
namespace PhotoBrushProject
{
	...
	public class HSLLinearForm : System.Windows.Forms.Form
	{
		...
		private RangeD	inSaturation = new RangeD(0, 1);
		private RangeD	inLuminance = new RangeD(0, 1);
		private RangeD	outSaturation = new RangeD(0, 1);
		private RangeD	outLuminance = new RangeD(0, 1);
