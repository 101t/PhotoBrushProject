...
namespace PhotoBrushProject
{
    ...
    /// </summary>
    public partial class DetailsForm : Form, IFormBuilder
    {
        private static DetailsForm instance = null;
        public static DetailsForm Instance { get { return instance == null ? instance = new DetailsForm() : instance; } }
    ...
    internal class ColorImageStatisticsDescription
    {
        ...
        public ColorImageStatisticsDescription(Bitmap image)
        {
            ...
            // gather statistics
            statRGB = new ImageStatistics(imgData, width, height, PixelFormat.Format24bppRgb);
            statHSL = new ImageStatisticsHSL(imgData, width, height);
            statYCbCr = new ImageStatisticsYCbCr(imgData, width, height);
