...
namespace PhotoBrushProject
{
	...
	public class FilterPreview : System.Windows.Forms.Control
	{
		...
		public FilterPreview()
		{
            ...
            //cursorHand = new System.Windows.Forms.Cursor(assembly.GetManifestResourceStream("PhotoBrushProject.Resources.harrow.cur"));
            //cursorHandMove = new System.Windows.Forms.Cursor(assembly.GetManifestResourceStream("PhotoBrushProject.Resources.hmove.cur"));
            Stream imgStream = null;
            try
            {
                Assembly a = Assembly.GetExecutingAssembly();

                imgStream = a.GetManifestResourceStream("PhotoBrushProject.Resources.harrow.cur");
                if (imgStream != null)
                {
                    cursorHand = new Cursor(imgStream);
                    imgStream = null;
                }
                else
                    cursorHand = Cursors.SizeAll;

                imgStream = a.GetManifestResourceStream("PhotoBrushProject.Resources.hmove.cur");
                if (imgStream != null)
                {
                    cursorHandMove = new Cursor(imgStream);
                    imgStream = null;
                }
                else
                    cursorHandMove = Cursors.Hand;
            }
            catch { }
		}
