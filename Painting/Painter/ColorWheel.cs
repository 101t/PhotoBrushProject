...
public class ColorWheel : IDisposable
{
    ...
    public int Alpha
    {
        ...
        set
        {
            selectedColor = Color.FromArgb(value, selectedColor.R,
    ...
    public void UpdateAlpha(int Alpha)
    {
        ...
        selectedColor = Color.FromArgb(this.RGB.Alpha, this.RGB.Red, this.RGB.Green, this.RGB.Blue);
    }
    ...
    private void UpdateDisplay()
    {
        ...
        using (Brush selectedBrush = new SolidBrush(
            Color.FromArgb(selectedColor.R, selectedColor.G, selectedColor.B)))
        {
